...
class GameHistoryService
{
    ...
    public function getHorizontalSuccess(array $gameHistories, array $playerHistories, int $gameSize): array
    {
        $horizontalSuccess = [];
    ...
    public function getVerticalSuccess(array $gameHistories, array $playerHistories, int $gameSize): array
    {
        $verticalSuccess = [];
    ...
    public function getDiagonalRightSuccess(array $gameHistories, array $playerHistories, int $gameSize): array
    {
        $diagonalRightSuccess = [];
        $diagonalRight = 0;
    ...
    public function getDiagonalLeftSuccess(array $gameHistories, array $playerHistories, int $gameSize): array
    {
        $diagonalLeftSuccess = [];
        $diagonalLeft = 0;
